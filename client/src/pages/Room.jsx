    ...
    >
      ...
      <main className="max-w-[1800px] mx-auto p-4 md:p-8 flex flex-col lg:grid lg:grid-cols-5 gap-6 h-[calc(100vh-140px)] lg:h-[calc(100vh-80px)] overflow-hidden">
        ...
        <div className="flex-1 overflow-hidden relative">
          ...
          {/* PLAYER TAB - Now contains Player, Search, Fav, Queue on Mobile */}
          <div className={`${mobileTab === 'player' ? 'flex animate-in fade-in slide-in-from-bottom-4 duration-300' : 'hidden'} lg:flex lg:col-span-2 flex-col gap-4 h-full overflow-hidden`}>
            ...
            {/* Bottom Container - Subtabs for Mobile, Sidebar for Desktop */}
          ...
          <div className={`${mobileTab === 'search' ? 'flex lg:hidden animate-in fade-in slide-in-from-bottom-4 duration-300' : 'hidden'} lg:flex h-full flex-col lg:col-span-1`}>
            <MusicSearch />
          </div>

          <div className={`${mobileTab === 'extras' ? 'flex animate-in fade-in slide-in-from-bottom-4 duration-300' : 'hidden'} flex-col gap-6 h-full overflow-y-auto pb-32`}>
            <CoupleFeatures username={state?.username} />
          </div>
