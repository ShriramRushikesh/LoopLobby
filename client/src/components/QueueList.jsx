  ...
  if (!room?.queue || room.queue.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-8 text-center h-full">
        ...
        <p className="text-zinc-500 font-bold tracking-tight text-xs uppercase">Your queue is empty.</p>
        <p className="text-zinc-600 text-[10px] mt-1 mb-6">Add some songs to keep the vibe alive!</p>
  ...
  return (
    <div className="space-y-2 p-2">
      <div className="px-2 pb-2 flex items-center justify-between">
        <span className="text-[9px] font-black uppercase tracking-widest text-zinc-600">Up Next ({room.queue.length})</span>
      </div>
